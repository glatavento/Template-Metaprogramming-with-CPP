...
\subsubsection{5.5.2\hspace{0.2cm}查询类型属性}
...
\subsubsection{5.5.3\hspace{0.2cm}查询支持的操作}
...
\subsubsection{5.5.4\hspace{0.2cm}查询类型的关系}
...
\subsubsection{5.5.6\hspace{0.2cm}各种转换}
